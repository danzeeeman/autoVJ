...
public:
    ...
    void setup(bool useExternal = false); //whether you want your sounds in a 0-1 range or a 0-volumeRange - setting volume range doesn't matter if you're normalizing
    void update();
    void update(vector<float>& bins);
